...
export async function onSuccess({ params, record, logger, api, connections }) {
  ...
  const functions = {
    fetchParcelDataByOrderId: {
      enabled: record.functions.fetchParcelDataByOrderId,
      function: {
    ...
    fetchProductRecommendation: {
      enabled: record.functions.fetchProductRecommendation,
      function: {
    ...
    sendToCustomerSupport: {
      enabled: record.functions.sendToCustomerSupport,
      function: {
    ...
    fetchParcelDataByEmail: {
      enabled: record.functions.fetchParcelDataByEmail,
      function: {
    ...
    fetchProductByTitle: {
      enabled: record.functions.fetchProductByTitle,
      function: {
  ...
  const assistant = await connections.openai.beta.assistants.update(record.assistant, {
    instructions:
      `
